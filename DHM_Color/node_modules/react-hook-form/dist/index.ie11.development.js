...
function findRemovedFieldAndRemoveListener(fieldsRef, handleChange, field, unmountFieldsStateRef, defaultValuesRef, shouldUnregister, forceDelete) {
    ...
    if (!shouldUnregister) {
        var value = getFieldValue(fieldsRef, name, unmountFieldsStateRef, defaultValuesRef);
...
var getFieldsValues = (function (fieldsRef, unmountFieldsStateRef, defaultValuesRef, search) {
    var output = {};
    ...
    return __assign(__assign(__assign({}, transformToNestObject(defaultValuesRef.current)), transformToNestObject(unmountFieldsStateRef.current)), transformToNestObject(output));
});
...
var validateField = (function (fieldsRef, validateAllFieldCriteria, _a, unmountFieldsStateRef, defaultValuesRef) {
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                case 0:
                    ...
                    fieldValue = getFieldValue(fieldsRef, name, unmountFieldsStateRef, defaultValuesRef);
...
function useForm(_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, validateField(fieldsRef, isValidateAllFieldCriteria, fieldsRef.current[name], unmountFieldsStateRef, defaultValuesRef)];
                case 1:
                    error = _a.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, validateField(fieldsRef, isValidateAllFieldCriteria, field, unmountFieldsStateRef, defaultValuesRef)];
                        case 3:
                            error = _c.sent();
                            _c.label = 4;
                        case 4:
    ...
    function getValues(payload) {
        ...
        if (isArray(payload)) {
            return payload.reduce(function (previous, name) {
                var _a;
                return (__assign(__assign({}, previous), (_a = {}, _a[name] = getFieldValue(fieldsRef, name, unmountFieldsStateRef, defaultValuesRef), _a)));
            }, {});
        }
    ...
    var removeFieldEventListener = React.useCallback(function (field, forceDelete) {
        return findRemovedFieldAndRemoveListener(fieldsRef, handleChangeRef.current, field, unmountFieldsStateRef, defaultValuesRef, shouldUnregister, forceDelete);
    }, [shouldUnregister]);
    ...
    var watchInternal = React.useCallback(function (fieldNames, defaultValue, watchId) {
        ...
        var combinedDefaultValues = isUndefined(defaultValue)
            ...
            : defaultValue;
        var fieldValues = getFieldsValues(fieldsRef, unmountFieldsStateRef, defaultValuesRef, fieldNames);
    ...
    function registerFieldRef(ref, validateOptions) {
        ...
        if (resolver && !isFieldArray && readFormStateRef.current.isValid) {
            ...
            if (!isOnSubmit && readFormStateRef.current.isValid) {
                validateField(fieldsRef, isValidateAllFieldCriteria, field, unmountFieldsStateRef, defaultValuesRef).then(function (error) {
        ...
        if (!defaultValuesAtRenderRef.current[name] &&
            ...
            var fieldValue = getFieldValue(fieldsRef, name, unmountFieldsStateRef, defaultValuesRef);
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, validateField(fieldsRef, isValidateAllFieldCriteria, field, unmountFieldsStateRef, defaultValuesRef)];
                case 5:
                    fieldError = _e.sent();
